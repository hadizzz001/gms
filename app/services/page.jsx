        ...
        <div className="site-wrapper">
          ...
          <div className="section section--half-image-half-text">
            ...
            <div className="half-text">
              ...
              <p>
                GMS Power Generation stems from humble roots in the service sector providing generator maintenance and
                emergency response service to local customers. From here we have grown to a company with the same core
                values, but a larger servicing area, and a wider range of products and product support for our customers. We
                services hundreds of generators across Lebanon in all major sectors. We understand the importance of service
                and sales, and our differing departments work cohesively to serve a common goal; the satisfied consumer. We
                provide temporary power systems in the events of failure, and 24/7 emergency response to all customers. Our
                capabilities are unlimited when it comes to the manufacture, sales, and service of your power generation
                equipment, and we look forward to working with you on your next project.
              </p>
            </div>
          </div>
          <div className="section section--half-image-half-text">
            ...
            <div className="half-text">
              ...
              <p>
                We have a global experience in building and operating turn-key power plants in extreme conditions, applications and
                environments. We deliver durable and reliable products along with the experience and the flexibility to support the
                development, engineering, installation and maintenance of power plants
              </p>
          ...
          <div className="section section--half-image-half-text">
            ...
            <div className="half-text">
              <div className="title">RENTAL POWER</div>
              <p>
                We offer a range of energy solutions to serve temporary and medium-term energy needs ac. With an experienced
                Technical team of proven capabilities in meeting energy needs, we offer complete solutions to match your exact
                requirements.
              </p>
            </div>
          </div>
          <div className="section section--half-image-half-text">
            ...
            <div className="half-text">
              <div className="title">LV PANEL BOARDS</div>
              <p>
                Whether for power or control, we provide the highest quality power products and services covering a wide range of
                applications up to 6,300 Amps in 3 or 4-pole systems according to international standards such as ISO 9001, BS, IEC,
                NEMA, etc.

              </p>
              <p>We have:</p>
              <ul>
                <li>Automatic and/or manual transfer switches 3 or 4 pole. </li>
                <li>Synchronized panels with or without grid.</li>
                <li>Double change over switches</li>
                <li>Totalizing and distribution panels.</li>
              </ul>
            </div>
          </div>
          <div className="section section--half-image-half-text">
            ...
            <div className="half-text">
              <div className="title">MV SWITCHGEARS</div>
              <p>
                We support a wide range of Transformers and Medium Voltage Switchgears, up to a rated voltage of 24 kV, and rated
                current up to 1,250 Amps.
              </p>
            </div>
          </div>
          <div className="section section--half-image-half-text">
            ...
            <div className="half-text">
              ...
              <p>Our mission is to satisfy our customers by providing professional, pro-active and timely service throughout our
                product range.
                Our expert team of engineers and skilled technicians ensures rapid and trouble-free on-site maintenance. Our
                packages include installation and commissioning of the generating sets, offering our clients the most reliable and
                timely service. To ensure customers obtain the maximum benefit from our products, our qualified personnel provide
                training programs for our clients. Our premises are equipped with up-to-date technology to improve the training
                environment.</p>
            </div>
          </div>
          <div className="section section--half-image-half-text">
            ...
            <div className="half-text">
              ...
              <p>"Trustful choice for Power Solutions"</p>
            </div>
          </div>
          <div className="section section--half-image-half-text">
            <div className="half-image">
            ...
            <div className="half-text">
              ...
              <p>Excellence: "Everything we provide, must be according to expectations"</p>
            <ul>
              <li>Dynamic: "Willing to embrace change"</li>
              <li>Leadership: "To guide others openly and honestly"</li>
              <li>Accountability: "Performance depend on our actions"</li>
              <li>Awareness: "Be prepared to deliver excellence"</li>
            </ul>
            </div>
          </div>
          <div className="section section--half-image-half-text">
            ...
            <div className="half-text">
              <div className="title">Major Product Supplies</div>
               <ul>
              <li>Diesel Generators from 5 kVA up to 3000 kVA</li>
              <li>Power Plants Solutions</li>
              <li>Synchronizing & Distribution Panels</li>
              <li>Sound Proofing Systems</li>
              <li>Lighting Towers</li>
              <li>Fuels Tanks</li>
              <li>Switchgears & Transformers</li>
              <li>Port-Cabinet Metallic Rooms</li>
              <li>Earth Moving Equipment’s</li>
            </ul>
            </div>
          </div>
